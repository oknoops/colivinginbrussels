...
1. Secure an address where you're allowed to register (more on this below).
2. Book an appointment at the commune for that address.
3. A local police officer may visit to confirm you actually live there.
4. You're entered in the register and can obtain your residence document.

Each of Brussels' 19 communes runs its own office with its own appointment system, so check your specific commune's website for documents and booking. If you're weighing where to base yourself, our [neighbourhoods guide](/neighborhoods) compares popular areas like [Ixelles](/neighborhoods/ixelles) and [Etterbeek](/neighborhoods/etterbeek).
...
## A sensible first-month order of operations

1. Confirm and secure your visa/permit basis before travelling.
2. Book short-term or coliving housing that allows address registration.
3. Register at your commune (domiciliation) if staying over three months.
4. Open a Belgian bank account.
5. Sort a local SIM and a public-transport pass, and settle in.
...
**Do landlords in Brussels require a guarantor?**
Traditional landlords often do. Coliving operators typically do not require a Belgian guarantor, which is why many non-EU newcomers start there.

## Start with the right home base

Getting settled is far smoother when your housing doesn't fight you on guarantors and long leases. Take our [matchmaker quiz](/matchmaker) to find flexible, no-guarantor coliving that fits your situation, then compare every operator on our [operators page](/actors).
