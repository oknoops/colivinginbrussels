---
title: "Checklist para mudarse a Bruselas: todo lo que necesitas en tu primer mes"
excerpt: "La checklist definitiva para tu primer mes al mudarte a Bruselas: desde el registro en el ayuntamiento hasta encontrar médico, conseguir una tarjeta SIM y mucho más."
date: "2026-02-28"
...
tags: ["Expatriados", "Guía", "Práctico"]
---

# Checklist para mudarse a Bruselas: todo lo que necesitas en tu primer mes

Tu primer mes en Bruselas marca el tono de toda tu experiencia. Resuelve lo esencial pronto y te sentirás instalado en semanas en lugar de meses. Sáltate pasos clave y te pasarás medio año persiguiendo trámites burocráticos.

Esta checklist cubre todo lo que necesitas hacer en tus primeros 30 días, más o menos en el orden en que deberías abordarlo.

## Semana 1: lo esencial

### Encuentra alojamiento

Si no has asegurado un alojamiento antes de llegar, esta es la prioridad número uno. Operadores de coliving como Cohabs, Corners, Colive y LiveColonies ofrecen disponibilidad para mudarte esa misma semana en la mayoría de los casos. Para alquileres tradicionales, cuenta con que el proceso lleve entre 1 y 3 semanas.

### Consigue una tarjeta SIM belga
...
### Abre una cuenta bancaria belga
...
### Regístrate en tu ayuntamiento (commune)

Este es el trámite administrativo más importante. Dentro de los ocho días hábiles posteriores a tu mudanza, acude a la oficina de tu commune (municipio) local para registrar tu dirección.

**Qué llevar:**

- Pasaporte o documento de identidad de la UE
- Contrato de alquiler
- Fotos tamaño carné (algunas communes las exigen)
- Justificante de empleo o matrícula (si procede)

Tras el registro, la commune envía a un agente de la policía local a verificar tu dirección. Asegúrate de que haya alguien en casa o deja una nota en la puerta confirmando que vives allí. Una vez verificado, recibirás tu tarjeta de residencia (para ciudadanos de la UE) o iniciarás el proceso de permiso de residencia (ciudadanos de fuera de la UE).

**Consejo práctico:** algunas communes de Bruselas tienen sistemas de cita online. Consulta la web de tu commune: Ixelles, Etterbeek y Saint-Gilles permiten reservar cita online, lo que te ahorra horas de cola.

## Semana 2: sanidad y seguros

### Afíliate a una mutuelle (mutua de salud)
...
### Encuentra un médico (médecin généraliste)

Regístrate con un médico de cabecera local. En Bélgica puedes acudir a cualquier médico, pero tener uno de cabecera fijo (médecin traitant / huisarts) te da mejores tasas de reembolso. Pide recomendaciones a tus compañeros de coliving o de trabajo: el boca a boca es la mejor forma de encontrar un buen médico en Bruselas.

Una consulta estándar de médico de cabecera cuesta entre 25 y 30 EUR, de los que tu mutuelle te reembolsa aproximadamente entre 20 y 23 EUR.
...
### Consigue una tarjeta MOBIB

La tarjeta MOBIB es la tarjeta inteligente de transporte público de Bruselas, que se usa en los autobuses, tranvías y metros de STIB/MIVB. Cómprala en cualquier STIB Bootik (con puntos en Porte de Namur, Rogier, Gare du Midi) o en las máquinas expendedoras de STIB por 5 EUR.

**Mejores opciones de abono:**
...
Para necesidades puntuales de coche, Cambio (coche compartido) es mejor que tener vehículo propio. Los planes empiezan en 5 EUR/mes más las tarifas de uso. Reserva a través de la app y recoge el coche en estaciones repartidas por Bruselas.

## Semana 3: montar tu día a día

### Encuentra tus supermercados
...
Recorre a pie cada calle en un radio de 15 minutos de tu casa. Encuentra tu panadería local, tu terraza favorita y ese banco tranquilo del parque donde leerás los domingos por la mañana. Bruselas se revela a quienes deambulan.
...
Aquí tienes todo resumido para consultarlo fácilmente:

- [ ] Asegurar alojamiento (coliving o alquiler)
- [ ] Comprar una tarjeta SIM belga
- [ ] Abrir una cuenta bancaria belga
- [ ] Registrarse en el ayuntamiento (commune)
- [ ] Afiliarse a una mutuelle (seguro de salud)
- [ ] Encontrar un médico de cabecera local
- [ ] Contratar seguro de hospitalización y de responsabilidad civil
- [ ] Comprar una tarjeta MOBIB y un abono de transporte
- [ ] Contratar internet (si no vives en coliving)
- [ ] Descargar las apps imprescindibles (STIB, Itsme, Payconiq)
- [ ] Encontrar tus supermercados y el mercado local
- [ ] Unirse a comunidades sociales y asistir a eventos
- [ ] Empezar a aprender francés o neerlandés

Aborda esto durante tu primer mes y tendrás una base sólida para tu vida en Bruselas. La burocracia puede resultar pesada, pero cada paso completado hace que el siguiente sea más fácil. Bienvenido a Bélgica.
