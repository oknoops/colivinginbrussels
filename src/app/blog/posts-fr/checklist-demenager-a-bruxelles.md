...
tags: ["Expats", "Guide", "Pratique"]
---

# Checklist pour déménager à Bruxelles : tout ce qu'il vous faut le premier mois

Votre premier mois à Bruxelles donne le ton de toute votre expérience. Réglez l'essentiel rapidement et vous vous sentirez chez vous en quelques semaines plutôt qu'en quelques mois. Sautez des étapes clés et vous courrez après la paperasse pendant six mois.

Cette checklist couvre tout ce que vous devez faire durant vos 30 premiers jours, à peu près dans l'ordre où vous devriez vous y prendre.

## Semaine 1 : l'essentiel

### Trouver un logement

Si vous n'avez pas encore trouvé de logement avant d'arriver, c'est la priorité numéro un. Des opérateurs de coliving comme Cohabs, Corners, Colive et LiveColonies proposent dans la plupart des cas une emménagement dans la semaine. Pour une location classique, comptez 1 à 3 semaines pour boucler le processus.

### Obtenir une carte SIM belge
...
### S'inscrire à sa commune

C'est l'étape administrative la plus importante. Dans les huit jours ouvrables suivant votre emménagement, rendez-vous au bureau de votre commune (municipalité) pour y déclarer votre adresse.

**Ce qu'il faut apporter :**

- Passeport ou carte d'identité européenne
- Contrat de location
- Photos format passeport (certaines communes les exigent)
- Preuve d'emploi ou d'inscription (le cas échéant)
...
### Adhérer à une mutuelle (organisme d'assurance maladie)
...
### Obtenir une carte MOBIB

La carte MOBIB est la carte à puce des transports publics bruxellois, utilisée sur les bus, trams et métros de la STIB/MIVB. Achetez-en une dans n'importe quelle Bootik STIB (à la Porte de Namur, à Rogier, à la Gare du Midi) ou aux distributeurs automatiques de la STIB pour 5 EUR.

**Les meilleures formules d'abonnement :**
...
Pour les besoins occasionnels d'une voiture, Cambio (autopartage) vaut mieux que d'en posséder une. Les forfaits démarrent à 5 EUR/mois plus les frais d'utilisation. Réservez via l'appli et récupérez le véhicule dans les stations réparties dans Bruxelles.

## Semaine 3 : organiser le quotidien

### Repérer vos supermarchés
...
Arpentez chaque rue dans un rayon de 15 minutes autour de chez vous. Trouvez votre boulangerie locale, votre terrasse préférée et le banc de parc tranquille où vous lirez le dimanche matin. Bruxelles se révèle à ceux qui flânent.
...
Voici un récapitulatif de tout, pour référence rapide :

- [ ] Trouver un logement (coliving ou location)
- [ ] Acheter une carte SIM belge
- [ ] Ouvrir un compte bancaire belge
- [ ] S'inscrire à sa commune
- [ ] Adhérer à une mutuelle (assurance maladie)
- [ ] Trouver un généraliste local
- [ ] Souscrire une assurance hospitalisation et responsabilité civile
- [ ] Acheter une carte MOBIB et un abonnement de transport
- [ ] Installer Internet (si vous n'êtes pas en coliving)
- [ ] Télécharger les applis indispensables (STIB, Itsme, Payconiq)
- [ ] Repérer vos supermarchés et votre marché local
- [ ] Rejoindre des communautés sociales et participer aux événements
- [ ] Commencer à apprendre le français ou le néerlandais

Réglez tout cela durant votre premier mois et vous poserez des bases solides pour votre vie à Bruxelles. La bureaucratie peut sembler lourde, mais chaque étape franchie rend la suivante plus facile. Bienvenue en Belgique.
