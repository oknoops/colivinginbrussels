...
tags: ["S'installer à Bruxelles", "Nouveaux arrivants", "Expats", "Checklist"]
---
...
*   **Procurez-vous une carte SIM belge.** Prenez une SIM prépayée (Orange, Proximus, BASE, ou des options budget comme Scarlet) dans n'importe quelle boutique de téléphonie ou au supermarché. Vous aurez besoin de données mobiles pour les cartes et l'administratif.
*   **Réglez vos transports.** Téléchargez l'appli STIB/MIVB (métro, tram, bus) et, pour les trains, l'appli SNCB/NMBS. Vous pouvez taper directement une carte bancaire sans contact aux portiques de la STIB ; procurez-vous une **carte MOBIB** pour un abonnement mensuel une fois installé.
*   **Repérez vos essentiels.** Localisez votre supermarché le plus proche (Delhaize, Carrefour, Colruyt, ou les moins chers Aldi/Lidl), la pharmacie et la *boulangerie*. À noter : beaucoup de commerces ferment le dimanche.
...
*   Cela débloque tout le reste : titre de séjour, compte bancaire à long terme, mutuelle.

Notre [guide complet de la domiciliation](/fr/blog/louer-a-bruxelles-guide) couvre les détails et la paperasse.
...
L'administratif est épuisant ; équilibrez. Passez un après-midi à réellement *profiter* de la ville :

*   Baladez-vous sur la **Grand-Place**, puis échappez aux touristes vers **Sainte-Catherine** pour une croquette de crevettes et un verre de blanc.
*   Prenez vos premières **frites** dans un vrai *fritkot* (voir notre [guide du coliving à Bruxelles](/fr/coliving-bruxelles)).
*   Flânez dans votre propre quartier jusqu'à trouver *votre* café et *votre* boulangerie.

## Jour 5–7 : Branchez-vous à la communauté
...
- [ ] SIM belge + données
- [ ] Appli STIB + carte MOBIB
- [ ] Domicilié (ou rendez-vous pris) à la commune
- [ ] Banque réglée (temporaire + local en cours)
- [ ] Mutuelle choisie
- [ ] Supermarché, pharmacie, boulangerie les plus proches localisés
...
**Toujours à la recherche d'un logement ?** Faites le [quiz de matchmaking](/matchmaker), parcourez [tous les espaces de coliving](/actors), ou lisez notre [guide complet du coliving à Bruxelles](/fr/coliving-bruxelles).
