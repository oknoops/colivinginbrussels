...
1. Obtenir une adresse où vous êtes autorisé à vous inscrire (voir plus loin).
2. Prendre rendez-vous à la commune pour cette adresse.
3. Un agent de police local peut passer pour vérifier que vous y habitez réellement.
4. Vous êtes inscrit au registre et pouvez obtenir votre document de séjour.

Chacune des 19 communes bruxelloises gère son propre bureau avec son propre système de rendez-vous ; consultez donc le site de votre commune précise pour les documents et la prise de rendez-vous. Si vous hésitez sur l'endroit où vous baser, notre [guide des quartiers](/fr/quartiers) compare des zones populaires comme [Ixelles](/neighborhoods/ixelles) et [Etterbeek](/neighborhoods/etterbeek).
...
## Un ordre de marche sensé pour le premier mois

1. Confirmez et sécurisez la base de votre visa/permis avant de partir.
2. Réservez un logement court terme ou en coliving qui autorise l'inscription d'adresse.
3. Inscrivez-vous à votre commune (domiciliation) si vous restez plus de trois mois.
4. Ouvrez un compte bancaire belge.
5. Procurez-vous une SIM locale et un abonnement de transport, et installez-vous.
...
**Les propriétaires à Bruxelles exigent-ils un garant ?**
Les propriétaires traditionnels le font souvent. Les opérateurs de coliving n'exigent généralement pas de garant belge, ce qui explique pourquoi de nombreux nouveaux arrivants hors UE commencent par là.

## Commencez avec la bonne base

L'installation est bien plus fluide quand votre logement ne vous impose ni garant ni bail long. Faites notre [quiz de mise en relation](/matchmaker) pour trouver un coliving flexible et sans garant adapté à votre situation, puis comparez tous les opérateurs sur notre [page des opérateurs](/actors).
