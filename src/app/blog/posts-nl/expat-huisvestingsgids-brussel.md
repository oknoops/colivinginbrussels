...
Voor je begint te zoeken, is het goed te weten wat er in Brussel te vinden is:

### Private huur (studio of appartement)

Een alleenstaande huurwoning geeft je maximale privacy en onafhankelijkheid. Studio's in Brussel starten rond de 600-700 EUR/maand in betaalbaardere buurten zoals Schaarbeek, terwijl een appartement met één slaapkamer in populaire wijken zoals Elsene 800-1.200 EUR/maand kost. Je moet de woning zelf inrichten, tenzij je een gemeubelde (meublé) huurwoning vindt.

### Samenhuizen (colocation)

Een appartement delen met anderen is gebruikelijk onder jonge professionals. Een kamer in een gedeeld appartement kost doorgaans 400-700 EUR/maand plus kosten. Zoek op Immoweb, Facebook-groepen zoals "Flatshare Brussels / Colocation Bruxelles" of Appartager.

### Coliving

De meest expat-vriendelijke optie. Operatoren zoals Cohabs, Corners, Colive, LiveColonies, Ikoab, Neybor, Habyt en Morton Place bieden volledig gemeubelde kamers met all-in prijzen. De contracten zijn flexibel (vaak vanaf één maand) en het intrekproces verloopt vlot. De prijzen schommelen tussen 650 en 1.200 EUR/maand.

## Stap 2: Begin je zoektocht
...
De Brusselse huurmarkt draait het snelst in augustus-september (studentenseizoen) en januari. Begin 4 tot 6 weken voor je gewenste intrekdatum te zoeken voor private huur, of 2 tot 3 weken voor coliving (dat sneller wisselt).
...
## Stap 4: Begrijp de Belgische types huurcontract

Het Belgische huurrecht kent verschillende types huurcontract:

### Kortlopend huurcontract (max. 3 jaar)

Gebruikelijk voor expats. Kan voor eender welke periode tot drie jaar. Belangrijk: een kortlopend huurcontract kan door de huurder niet vroegtijdig worden opgezegd, tenzij er een specifieke clausule is die dat toelaat. Lees het contract zorgvuldig.

### Standaardcontract (9 jaar)

De standaard in België. Ondanks de naam zit je niet negen jaar vast. Na het eerste jaar kan je opzeggen met drie maanden opzegtermijn, al betaal je dan een verbrekingsvergoeding (drie maanden huur als je vertrekt in het eerste jaar, twee maanden in het tweede jaar, één maand in het derde jaar).

### Coliving-contracten

Coliving-operatoren gebruiken doorgaans hun eigen contractkaders. De meeste bieden maandelijks doorlopende contracten na een initiële engagementsperiode (meestal één tot drie maanden). De opzegtermijnen bedragen typisch één maand.

## Stap 5: De waarborg (huurwaarborg)

De Belgische wet vereist dat de huurwaarborg op een geblokkeerde bankrekening op naam van de huurder wordt geplaatst. De maximale waarborg bedraagt:
...
## Stap 6: Het huurcontract tekenen
...
## Stap 9: Domiciliëring (je adres registreren)

Binnen de acht dagen na je intrek moet je je inschrijven bij je gemeente. Dit heet domiciliëren en is vereist voor:

- Het verkrijgen van je Belgische verblijfskaart
- Toegang tot gezondheidszorg via een mutualiteit
- Het openen van een Belgische bankrekening (sommige banken vereisen het)

De gemeente stuurt een wijkagent langs om te controleren of je effectief op het adres woont. Zorg dat je de deur opendoet of een briefje achterlaat dat je aanwezigheid bevestigt.

## Stap 10: Intrek en settelen

Zodra je je sleutels hebt:
