---
title: "Openbaar vervoer in Brussel uitgelegd: metro, tram, bus & trein (2026)"
excerpt: "Alles wat je moet weten om je zonder auto door Brussel te verplaatsen. Tickets, apps, tips en de routes die elke expat zou moeten kennen."
date: "2026-02-21"
...
tags: ["Vervoer", "Brussel", "Praktische gids", "Expats", "Metro", "Tram"]
---
...
## Het MIVB/STIB-netwerk

De Brusselse vervoersmaatschappij is de **MIVB** (Nederlands: Maatschappij voor het Intercommunaal Vervoer te Brussel) / **STIB** (Frans: Société des Transports Intercommunaux de Bruxelles). Ze exploiteert:

- **4 metrolijnen** (lijnen 1, 2, 5, 6)
- **18 tramlijnen**
- **50+ buslijnen**
- Plus nachtbussen in het weekend

Het netwerk rijdt op weekdagen ongeveer van **5.30 uur tot middernacht**, met een lagere frequentie in het weekend en uitgebreide nachtbussen op vrijdag- en zaterdagnacht.

---

## De metro

Brussel heeft vier metrolijnen die samen een onderling verbonden netwerk over de hele stad vormen:

| Lijn | Belangrijkste haltes | Kleur |
|---|---|---|
| Lijn 1 | Koning Boudewijn ↔ Stokkel (via Rogier, De Brouckère, Schuman) | Blauw |
| Lijn 2 | Simonis ↔ Elisabeth (ringlijn, gedeeltelijk) | Oranje |
| Lijn 5 | Erasmus ↔ Herrmann-Debroux (via Schuman, Kunst-Wet) | Blauw |
| Lijn 6 | Koning Boudewijn ↔ Simonis (gedeeltelijke ring) | Oranje |

### Belangrijke metrostations voor expats
- **Schuman**: het hart van de Europese wijk. Commissie, Raad en Parlement liggen allemaal op wandelafstand.
- **Kunst-Wet/Arts-Loi**: belangrijk overstapstation; verbindt met Elsene en Etterbeek.
- **De Brouckère**: stadscentrum; nabij de Grote Markt en de grote winkelstraten.
- **Rogier**: buurt rond het Noordstation; verbindt met Thalys-treinen naar Parijs.
- **Louiza**: bovenaan Elsene; winkelen, Louizalaan.
...
Bussen vullen de gaten in het metro-/tramnetwerk op en bereiken zones die de sporen niet dekken.
...
- Goede prijs-kwaliteitverhouding voor occasioneel gebruik
...
- **65+**: verlaagde tarieven
- **MIVB-abonnement aan €8/maand** voor jongeren van 6 tot 24 jaar

---

## De MIVB-app

**Download de MIVB-app meteen.** Het is veruit het handigste hulpmiddel om je door Brussel te verplaatsen:
- Realtime vertrektijden aan elke halte
- Routeplanner
- Tickets kopen en bewaren (MOBIB-kaart of digitaal)
- Dienstregelingen van nachtbussen
- Meldingen van verstoringen op het netwerk

Beschikbaar op iOS en Android, volledig in het Engels, Frans en Nederlands.

---

## Gewestelijke treinen (NMBS/SNCB)

Voor reizen buiten Brussel of naar de luchthaven van Brussel gebruik je de **NMBS-treinen** (Nederlands) / **SNCB-treinen** (Frans).

### Belangrijke stations
- **Brussel-Zuid / Bruxelles-Midi**: het belangrijkste internationale station. Eurostar (Londen), Thalys/Eurostar (Parijs, Amsterdam, Keulen), TGV. Ook de bus naar de luchthaven van Charleroi.
- **Brussel-Centraal / Bruxelles-Central**: stadscentrum, het dichtst bij de Grote Markt.
- **Brussel-Noord / Bruxelles-Nord**: ten noorden van de stad, verbindt met Antwerpen en de luchthaventrein.
- **Brussel-Luxemburg**: in de Europese wijk; heel handig voor Etterbeek en het oosten van Elsene.
- **Station Etterbeek**: een kleiner station in Etterbeek; handig voor sommige zuidoostelijke routes.

### Luchthaven van Brussel
De trein **Airport City Express** rijdt vanuit alle 3 de grote Brusselse stations rechtstreeks naar de luchthaven van Zaventem in 17-22 minuten. Rijdt om de 15 minuten, kost ongeveer €13 enkele reis en is veruit de beste manier om naar de luchthaven te gaan.

---

## Fietsen in Brussel

Brussel verbetert zijn fietsinfrastructuur razendsnel, al loopt het nog achter op Amsterdam of Kopenhagen. Toch fietsen veel expats dagelijks zonder problemen.
...
Kort samengevat: **download de MIVB-app, neem een maandabonnement en geniet ervan dat je in een stad woont waar je echt geen auto nodig hebt**. Je portemonnee, het milieu en je parkeerstressniveau zullen je dankbaar zijn.

[Vind een centraal gelegen coliving-plek →](/actors) | [Verken wijken op basis van vervoersverbindingen →](/nl/wijken)
