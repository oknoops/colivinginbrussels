...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://colivinginbrussels.com/fr/coliving/${slug}`,
            languages: {
        ...
        openGraph: { title: ui.metaTitle(content.name), description: ui.metaDesc(content.name, hood.avgRent), locale: 'fr_BE', type: 'article' },
    };
}
