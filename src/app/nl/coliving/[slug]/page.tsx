...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://colivinginbrussels.com/nl/coliving/${slug}`,
            languages: {
        ...
        openGraph: { title: ui.metaTitle(content.name), description: ui.metaDesc(content.name, hood.avgRent), locale: 'nl_BE', type: 'article' },
    };
}
